...
class QdrantVectorSearchTool(BaseTool):
    ...
    def __init__(self, **kwargs):
        ...
        if QDRANT_AVAILABLE:
            ...
            # self.encoder = TextEmbedding("BAAI/bge-small-en")
...
#     )
#     result = tool.run(
#         "What is the maintenance obligations between the contract of DIGITAL CINEMA DESTINATIONS CORP and Cybergy Holdings Inc?"
#     )
#     print("result", result)
